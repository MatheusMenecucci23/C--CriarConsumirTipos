...
namespace certificacao_csharp_roteiro
{
    class ParametrosOpcionais : IAulaItem
    {
        ...
        {
            ClienteEspecial clienteEspecial = new ClienteEspecial("Lucas Skywalk");
    ...
    class ClienteEspecial
    {
        ...
        //o nome virou um parametero opcional
        public ClienteEspecial(string nome = "Anônimo")
        {
            this.nome = nome;
        }
        //os parametros opcionais tem que ficar nas ultimas posições da lista de argumentos
